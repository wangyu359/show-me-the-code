...
class Make_xml(): # the parameter of class is for the base class
  ...
  def add_child(self, item, comment=None):
    # attention chinese
    new_node = self.create_node('number', json.dumps(item,indent=4,\
                                                      ensure_ascii=False,\
                                                      separators=(',',':')),comment)
...
-->
'''
  xml_path = r'C:/Users/王宇树/Documents/wys/show-me-the-code/number.xml'    
  xls_path = r'C:/Users/王宇树/Documents/wys/show-me-the-code/number.xls'       
